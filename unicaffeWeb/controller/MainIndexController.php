<?php
namespace unicaffeWeb\controller;

use unicaffeWeb\dao\LaboratorioDAO;
use unicaffeWeb\dao\PerfilDAO;
use unicaffeWeb\util\Sessao;
use unicaffeWeb\view\HomeView;
...
<body>
	...
	<div class="pagina doze colunas">
		<div class="topo doze linha fundo-branco">
			<div class="conteudo">
				<div id="logo-unicaffe">
                        ...
                        <a href="https://unilab.edu.br"> <img alt="logotipo da Unilab" src="img/logo_unilab.png" title="Ir para Unilab"></a>
		...
		echo '</ul></li>
				...
				<li><a href="?pagina=maquinas&laboratorio='.$listaDeLaboratorios[0]->getNome().'">Máquinas</a></li>';
		...
		if($sessao->getNivelAcesso() == Sessao::NIVEL_ADMIN || $sessao->getNivelAcesso() == Sessao::NIVEL_SUPER){
			...
			<ul class="seta-pra-cima">
				<li><a href="?pagina=gerenciamento_relatorios">Acessos por Usuário</a></li>
				<li><a href="?pagina=gerenciamento_administrador">Cadastro de Administrador</a></li>
				<li><a href="?pagina=relatorios">Utilização Por Turno</a></li>
				<li><a href="?pagina=mensagens">Envio de Mensagens</a></li>
