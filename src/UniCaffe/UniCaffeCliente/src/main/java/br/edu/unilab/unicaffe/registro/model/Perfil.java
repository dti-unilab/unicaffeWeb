...
public class Perfil {
	...
	public static Collection<Registro> listaParaBloqueio() {
		...
		lista.add(new Registro("HKLM\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Policies\\Explorer", "NoDrives",
				Registro.REG_DWORD, "0x00000c", "0", "Não pode ver o disco C:"));
		...
		lista.add(new Registro("HKCU\\Software\\Microsoft\\Windows\\CurrentVersion\\Policies\\Explorer\\DisallowRun",
				"1", Registro.REG_SZ, "PCFasterSvc.exe", "", "Baidu"));
		lista.add(new Registro("HKCU\\Software\\Microsoft\\Windows\\CurrentVersion\\Policies\\Explorer\\DisallowRun",
				"2", Registro.REG_SZ, "BavSvc.exe", "", "Baidu"));
		lista.add(new Registro("HKCU\\Software\\Microsoft\\Windows\\CurrentVersion\\Policies\\Explorer\\DisallowRun",
				"3", Registro.REG_SZ, "BHipsSvc.exe", "", "Baidu"));
		lista.add(new Registro("HKCU\\Software\\Microsoft\\Windows\\CurrentVersion\\Policies\\Explorer\\DisallowRun",
				"4", Registro.REG_SZ, "bavhm.exe", "", "Baidu"));
		lista.add(new Registro("HKCU\\Software\\Microsoft\\Windows\\CurrentVersion\\Policies\\Explorer\\DisallowRun",
				"5", Registro.REG_SZ, "Updater.exe", "", "Baidu"));
		lista.add(new Registro("HKCU\\Software\\Microsoft\\Windows\\CurrentVersion\\Policies\\Explorer\\DisallowRun",
				"6", Registro.REG_SZ, "Bav.exe", "", "Baidu"));
		lista.add(new Registro("HKCU\\Software\\Microsoft\\Windows\\CurrentVersion\\Policies\\Explorer\\DisallowRun",
				"7", Registro.REG_SZ, "PCFTray.exe", "", "Baidu"));
		lista.add(new Registro("HKCU\\Software\\Microsoft\\Windows\\CurrentVersion\\Policies\\Explorer\\DisallowRun",
				"8", Registro.REG_SZ, "PCFasterSvc.exe", "", "Baidu"));
		lista.add(new Registro("HKCU\\Software\\Microsoft\\Windows\\CurrentVersion\\Policies\\Explorer\\DisallowRun",
		...
		lista.add(new Registro("HKCU\\Control Panel\\Desktop", "ScreenSaveTimeOut", Registro.REG_SZ, "60", "60",
				"Determina o tempo"));
		lista.add(new Registro("HKCU\\Control Panel\\Desktop", "ScreenSaveActive", Registro.REG_SZ, "1", "0",
		...
		lista.add(new Registro("HKLM\\Software\\Microsoft\\Windows\\CurrentVersion\\Policies\\Explorer",
				"StartMenuLogoff", Registro.REG_DWORD, "1", "0", "Ativa proteção de tela"));
		lista.add(new Registro("HKLM\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Policies\\System",
